	...
	<div class="row" id="banner">
		...
		<div id="body">
			<ol class="breadcrumb">
			    ...
			    <li><a href="/zhaosheng/index.php/Home/Index/list_H/category/<?php echo ($nav['category']); ?>"><?php text($nav['category']);?></a></li>
			    <li>内容</li>
			</ol>
			<div id="content">
				<h1><?php echo ($data["title"]); ?></h1>
				<div style="width:600px;margin: 36px auto;">
					<span class="mes">作者：<?php echo ($data["author"]); ?></span>
					<span class="mes">日期：<?php echo (date("Y-m-d",$data["update_at"])); ?></span>
				</div>
				<div><?php $content = html_entity_decode($data['content']); echo $content; ?></div>
			</div>
		</div>
		<div id="footer">
	<div class="row">
