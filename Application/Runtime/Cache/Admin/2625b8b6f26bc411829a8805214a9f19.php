			...
			<div class="col-xs-10 col-sm-10 col-md-9 col-lg-9">
				<div class="panel panel-default">
		   			<div class="panel-body">
						...
						<div class="row">
							<div class="row">
								<form class="form-inline" role="form" action="/zhaosheng/index.php/Admin/Photo/index" method="get">
									<div class="col-md-3">
								...
								<div class="col-md-1 pull-right">
									<a href="/zhaosheng/index.php/Admin/Photo/create" class="btn btn-success">新增</a>
								</div>
							</div>
							...
							<tr>
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$photo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td>
											<a href="/zhaosheng/index.php/Admin/Photo/edit/id/<?php echo ($photo["id"]); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
											<a href="/zhaosheng/index.php/Admin/Photo/delete/id/<?php echo ($photo["id"]); ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
										</td>
