			...
			<div class="col-xs-10 col-sm-10 col-md-9 col-lg-9">
				<div class="panel panel-default">
		   			<div class="panel-body">
						...
						<div class="row">
							<div class="row">
								<form class="form-inline" role="form" action="/zhaosheng/index.php/Admin/Downfile/index" method="get">
									<div class="col-md-3">
								...
								<div class="col-md-1 pull-right">
									<a href="/zhaosheng/index.php/Admin/Downfile/create" class="btn btn-success">新增</a>
								</div>
							</div>
							...
							<tbody>
							<tr>
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$downfile): $mod = ($i % 2 );++$i;?><tr>
										<td><input class="checkbox-batch" name="checkbox[]" type="checkbox" data-group="downfiles"></td>
										<td><?php echo ($downfile["name"]); ?></td>
										<td>
											<?php if(($downfile["status"]) == "1"): ?>显示
											<?php else: ?>
											不显示<?php endif; ?>
										</td>
										<td><?php echo (date("Y-m-d",$downfile["update_at"])); ?></td>
										<td>
											<a href="/zhaosheng/index.php/Admin/Downfile/edit/id/<?php echo ($downfile["id"]); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
											<a href="/zhaosheng/index.php/Admin/Downfile/delete/id/<?php echo ($downfile["id"]); ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
										</td>
